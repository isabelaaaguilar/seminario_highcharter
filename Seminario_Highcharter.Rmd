...
## Introdução
  ...
  O **Highcharter** é um pacote para a biblioteca [Highcharts](https://www.highcharts.com/) para poder em JavaScript que oferece uma série de funções com a finalidade de facilitar a produção de gráficos e objetos dentro do R. 
